        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('name')) has-error @endif">
                    ...
                    <input type="text" id="role-field" name="role" class="form-control" value="{{ $user->role }}"/>
                       @if($errors->has("role"))
                    ...
                    <input type="text" id="image-field" name="image" class="form-control" value="{{ $user->image }}"/>
                       @if($errors->has("image"))
                    ...
                    <input type="text" id="remember_tolken-field" name="remember_tolken" class="form-control" value="{{ $user->remember_tolken }}"/>
